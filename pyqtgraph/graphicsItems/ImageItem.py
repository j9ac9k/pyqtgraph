    ...
    **Bases:** :class:`GraphicsObject <pyqtgraph.GraphicsObject>`
    ...
    def setCompositionMode(self, mode):
        ...
        mode : QtGui.QPainter.CompositionMode
            ...
            QPainter.CompositionMode.CompositionMode_SourceOver (Default) Image
            replaces the background if it is opaque. Otherwise, it uses the
            alpha channel to blend the image with the background.
